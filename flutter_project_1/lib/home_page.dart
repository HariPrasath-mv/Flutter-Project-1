...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  final List<Map<String, String>> _announcements = [
    {
      ...
      'description': 'Dear Residents, Electric Vehicle Charging Point Installation Guidelines of Resident is r ...',
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                  ...
                  return Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Image.network(
                          _ads[index]['image']!,
                          width: MediaQuery.of(context).size.width * 0.4, // 50% of the width
                          height: 100,
                          fit: BoxFit.cover,
                        ),
                      ],
            ...
            Row(
              ...
              children: List.generate(
                ...
                (index) => Container(
                  ...
                  decoration: BoxDecoration(
                    color: _currentAdIndex == index ? Colors.yellow : Colors.grey, // Active and inactive colors
            ...
            const SizedBox(height: 32), // Added more space between Gate Updates and Announcements
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                _buildGateUpdateItem('Add Visitor', Icons.person_add, Colors.green),
                _buildGateUpdateItem('Find Helper', Icons.search, Colors.blue),
                _buildGateUpdateItem('Upcoming Visitor', Icons.upcoming, Colors.orange),
                _buildGateUpdateItem('Past Visitor', Icons.history, Colors.grey),
              ],
            ),
          ),
  ...
  Widget _buildGateUpdateItem(String title, IconData icon, Color color) {
    return Container(
      ...
      margin: const EdgeInsets.only(right: 16,bottom: 10,top: 5), // Margin between items
